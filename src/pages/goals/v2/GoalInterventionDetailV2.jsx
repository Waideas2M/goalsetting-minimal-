...
const GoalInterventionDetailV2 = () => {
    ...
    if (!goal) return <V2PageLayout title="Intervention Detail">Goal not found.</V2PageLayout>;
    if (!intervention) return <V2PageLayout title="Intervention Detail">Intervention not found.</V2PageLayout>;
...
export default GoalInterventionDetailV2;
