...
import GoalTabsV2 from './GoalTabsV2';
import GoalStatusModal from '../../../components/GoalStatusModal';
import '../goals.css';

const V2PageLayout = ({ title, children, backLink = "/goals", isItemView = false, breadcrumbs = null, actions = null }) => {
    const { id } = useParams();
